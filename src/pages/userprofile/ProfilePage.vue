          ...
          <ion-row class="avatar-div">
            ...
            <ion-col class="height">
              <ion-row class="space">
                ...
                <ion-modal
                  trigger="user_detail_modal"
                  :initial-breakpoint="0.4"
                  :breakpoints="[0, 0.4, 0.5]"
                >
                  <div class="detail_modal_container">
                    <button class="setting_btn" @click="handleEditProfile">
                      <img src="/assets/icon/edit.svg" class="icon1" />
                      Edit Profile
                    </button>
                    <button class="setting_btn" @click="handleSupporters">
                      <img src="/assets/icon/hand.svg" class="icon1" />
                      All Supporters
                    </button>
                    <button class="setting_btn" @click="handleSupporters">
                      <img src="/assets/icon/hand.svg" class="icon1" />
                    ...
                    <button class="setting_btn" @click="handleFavorites">
                      <img src="/assets/icon/star.svg" class="icon1" />
                      Favourite List
                    </button>
                  </div>
                </ion-modal>
...
export default {
  ...
  methods: {
    ...
    async handleSupporters() {
      console.log('this is support button!!!')
